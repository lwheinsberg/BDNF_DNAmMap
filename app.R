  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "page5", 
              ...
              p("Note this application could not function without the accompanying database curated by Amery Treble-Barna and her team which included Lacey Heinsberg, Tara Davis, Stephen Breazeale, Zachary Stec, Aboli Kesbhat, Julia Tefs, and Ansuman Chattopadhyay. This curation took a great deal of collaborative effort and many many many hours of work. The paper that summarizes this effort can be found at [LINK TO BE ADDED UPON PUBLICATION].", style = "font-size:15px"),
      )
    )
  )
)
